...
students = [
    ...
    {"student_id": 102, "name": "Bob Smith", "department": "Mathsdematics", "enrollment_date": datetime(2024, 1, 15), "gpa": 3.5,"roll_id":2},
]
...
table.upsert(arrow_table, join_cols=["student_id"])
